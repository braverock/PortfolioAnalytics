...
\includegraphics[width=12cm,height=15cm,angle=270]{RelPerf_EW.eps}
\end{center}
\end{figure}
...
\caption{Summary statistics of monthly out-of-sample returns on equal weight, minimum CVaR (concentration) and minimum variance (concentration) investment strategies over the period January 1984 - June 2010. \label{Table:oosresults}    } \vspace{-0.5cm}
\vspace{1cm}\scalebox{0.7}{
\begin{tabular}{|lc c c cccc c cc c cccc c cc| } \hline
                  &          &  	Equal &
                  & \multicolumn{4}{l}{Min CVaR}  & & \multicolumn{2}{l}{Min CVaR Conc} &
                  &    \multicolumn{4}{l}{Min StdDev}  & & \multicolumn{2}{l|}{Min StdDev Conc}  \\
                             \cline{5-8} \cline{10-11} \cline{13-16} \cline{18-19}
                   &     &   Weight      &
                   &        &   40\% Pos   & 40\% CVaR 	     & ERC	      &     & 	   & 40\% Pos     &
                   &        &   40\% Pos   & 40\% StdDev     & ERC	      &     &      & 40\% Pos       \\
                    &          		 &        &
                    &          &  Limit	   & Alloc Limit	  &    		   &     &  &  Limit   &
                    &          & Limit	   & Alloc Limit	   &           &     &  & Limit 	       \\ \hline
 \multicolumn{19}{|l|}{\emph{Full period (in \%)}} \\
 \multicolumn{2}{|l}{Ann. Mean}   &         7.11 & &7.55 & 7.40 & 7.44 & 7.40 & & 7.40 & 7.33 & & 7.48 &  6.96 & 7.21 & 7.30 & & 7.30 & 7.17     \\
 \multicolumn{2}{|l}{Ann. StdDev} &         10.06 & & 4.72 & 8.52 & 6.61 & 7.42 & & 7.42 & 8.42  & & 4.62 & 8.18 & 6.13 & 7.02 & & 7.02 & 8.22  \\
  \multicolumn{2}{|l}{Skewness} &            -3.14 & & -0.49 & -2.36 & -1.92 & -2.35 & & -2.35 & -2.69 & &  -0.42 & -2.50 & -1.73 & -2.48 & & -2.48 & -2.89    \\
   \multicolumn{2}{|l}{Exc. Kurtosis} &       23.42 && 3.62 & 14.59 & 11.12 & 15.10 && 15.11 & 18.37  & &  1.86 & 16.99 & 10.55 & 17.19 & & 17.20 & 21.36    \\
 \multicolumn{2}{|l}{Monthly Hist CVaR} &     7.55 & & 2.62 & 6.17 & 4.51 & 5.14 & & 5.14 & 6.08& &  2.37 & 5.80 & 3.85 & 4.82 & & 4.82 & 5.93  \\
...
\vspace{1cm}\scalebox{0.7}{
\begin{tabular}{|lc c c ccc c cc c ccc c cc| } \hline
                  &          &  	Equal &
                  & \multicolumn{3}{l}{Min CVaR}  & & \multicolumn{2}{l}{Min CVaR Conc} &
                  &    \multicolumn{3}{l}{Min StdDev}  & & \multicolumn{2}{l|}{Min StdDev Conc}  \\
                             \cline{5-7} \cline{9-10} \cline{12-14} \cline{16-17}
                   &     &   Weight      &
                   &          40\% Pos   & 40\% CVaR 	     & ERC	      &     & 	   & 40\% Pos     &
                   &          40\% Pos   & 40\% StdDev 	     & ERC	      &     &      & 40\% Pos       \\
                    &          		 &        &
                    &           Limit	   & Alloc Limit	  &    		   &     &  &  Limit   &
                    &          Limit	   & Alloc Limit	   &           &     &  & Limit 	       \\ \hline
 \multicolumn{17}{|l|}{\emph{Full period (in \%)}} \\
 \multicolumn{2}{|l}{Ann. Mean}   &         10.91 & & 10.60 & 8.92 & 9.59 & & 9.59& 10.05  & &   9.12 & 8.27 & 8.83 &  & 8.82& 9.73         \\
 \multicolumn{2}{|l}{Ann. StdDev} &          6.59 & & 5.99 & 5.40 & 5.58 &  & 5.58& 5.93  & &  5.88 & 5.22 & 5.35 & & 5.35 & 5.75  \\
  \multicolumn{2}{|l}{Skewness} &           -0.41 & & -0.51 & -0.40 & -0.46&  & -0.46& -0.48  & &  -0.54 & -0.47 & -0.41 & & -0.41& -0.44      \\
   \multicolumn{2}{|l}{Exc. Kurtosis} &     0.75 & &1.68 & 2.36 & 1.57  & & 1.57& 1.29   & & 1.28 & 0.93 & 0.70 &  & 0.70 &  0.69 \\
 \multicolumn{2}{|l}{Monthly Hist CVaR} &     3.56 & & 3.04 & 2.85 & 2.90 & & 2.90&3.14  & &   3.03 & 2.72 & 2.65 && 2.65&2.95  \\
 \multicolumn{2}{|l}{Portfolio turnover}  &   18.99 & & 26.32 & 16.33 & 19.15 & & 19.14& 20.95   & & 22.31 & 14.23 & 13.00 & & 13.00& 19.01   \\
 \multicolumn{17}{|l|}{\emph{Bear stock market (in \%)}} \\
 \multicolumn{2}{|l}{Ann. Mean  }    &        2.88 & & 4.29 & 2.28 & 1.91 & & 1.91& 1.62  & & 0.65 & 2.76 & 0.79 &  & 0.79  & 2.59 \\
 \multicolumn{2}{|l}{Ann. StdDev}     &        7.35 & & 6.19 & 6.03 & 6.06 & & 6.06& 6.35 & &  6.13 & 5.96 & 5.88 & & 5.88 & 6.38     \\
