...
Fig 2.1
\end{center}
The CRSP data set is the daily returns of 30 small cap stocks from 1993-01 to 2015-12 from the Center for Research in Security Prices (CRSP). We use this larger and more frequent data set to show more meaningful and interesting results in Section 9. We don't want to use the large data set everywhere to slow down the code or distract the main point.
...
ret_CRSP = smallcapD[, apply(smallcapD, 2, function(y) all(!is.na(y)))]
