...
stocks <- getPCRAData(dataset = "stocksCRSPdaily")
...
```{r}
# get monthly return in last 5 years
data(stocksCRSP)
returnMat_M <- tapply(stocksCRSP[, Return], list(stocksCRSP$Date, stocksCRSP$TickerLast), I)
stocksCRSP_M <- xts(returnMat_M, as.Date(rownames(returnMat_M)))
retM_CRSP <- stocksCRSP_M[, sc_30]
